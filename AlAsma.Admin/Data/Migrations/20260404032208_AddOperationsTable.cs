        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookTitle = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    OperationDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Operations_Authors_AuthorId",
                        column: x => x.AuthorId,
